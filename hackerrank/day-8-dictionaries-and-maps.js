...
*/
	...
	console.log("to run: nodejs day-8-dictionaries-and-maps.js < day-8-dictionaries-and-maps.txt");
...
function processData(input) {
	...
	for (var ix = 1; ix <= n; ix++) {
		var d = lines[ix].split(' ');
		phoneBooks[d[0]] = d[1];
	}

	// continously process rest of the input
	for (/**/; ix < lines.length; ix++) {
		var v = phoneBooks[lines[ix]];
		if (v == undefined) {
			console.log("Not found");
		}
		else {
			console.log(lines[ix]+"="+v);
		}
	}
} 
