...
# correctly, each test case will print 2 or 3 lines (depending on whether or not a valid initialAge
...
//###################################################################
console.log("provide # of input line(s), and age(s) in three separate lines:");
...
function Person(initialAge) {
    ...
    this.amIOld=function(){
        ...
        else if (13 <= age && age < 18) { console.log("You are a teenager."); }
